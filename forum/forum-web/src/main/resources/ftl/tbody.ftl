...
<div id="content">
	<div id="content_con">
		...
		<div id="xwgk_xxgk">
			...
			<div id="xxgk">
				<h3><a href="channel/7" class="index_title_href">Introduction</a></h3>
				<div id="xxgk_bg"></div>
				${xxgk.summary[0..360]}
			</div>
		</div>
		<div id="hdjx_jyky">
			<@indexTopicList indexTopic=ts["3"] titleSize=31 divId="hdjx" hrefClz="index_link">
				<span class="t_title">${ts["3"].cname}</span><span class="more"><a href="channel/${ts['3'].cid}">more</a></span>
			</@indexTopicList>
			
			<@indexTopicList indexTopic=ts["4"] titleSize=31 divId="jyky" hrefClz="index_link">
				<span class="t_title">${ts["4"].cname}</span><span class="more"><a href="channel/${ts['4'].cid}">more</a></span>
			</@indexTopicList>
		</div>
